...
namespace RF.Common.Http
{
    public static class RequestHeaderNames
    {
        ...
        public static string GetName(this HttpRequestHeader header)
        {
            switch (header)
            {
                case HttpRequestHeader.Accept: return RequestHeaderNames.Accept;
                case HttpRequestHeader.AcceptCharset: return RequestHeaderNames.AcceptCharset;
                case HttpRequestHeader.AcceptEncoding: return RequestHeaderNames.AcceptEncoding;
                case HttpRequestHeader.AcceptLanguage: return RequestHeaderNames.AcceptLanguage;
                //case HttpRequestHeader.AcceptDatetime: return RequestHeaderNames.AcceptDatetime;
                case HttpRequestHeader.Authorization: return RequestHeaderNames.Authorization;
                case HttpRequestHeader.CacheControl: return RequestHeaderNames.CacheControl;
                case HttpRequestHeader.Connection: return RequestHeaderNames.Connection;
                case HttpRequestHeader.Cookie: return RequestHeaderNames.Cookie;
                case HttpRequestHeader.ContentLength: return RequestHeaderNames.ContentLength;
                case HttpRequestHeader.ContentMd5: return RequestHeaderNames.ContentMD5;
                case HttpRequestHeader.ContentType: return RequestHeaderNames.ContentType;
                case HttpRequestHeader.Date: return RequestHeaderNames.Date;
                case HttpRequestHeader.Expect: return RequestHeaderNames.Expect;
                case HttpRequestHeader.From: return RequestHeaderNames.From;
                case HttpRequestHeader.Host: return RequestHeaderNames.Host;
                case HttpRequestHeader.IfMatch: return RequestHeaderNames.IfMatch;
                case HttpRequestHeader.IfModifiedSince: return RequestHeaderNames.IfModifiedSince;
                case HttpRequestHeader.IfNoneMatch: return RequestHeaderNames.IfNoneMatch;
                case HttpRequestHeader.IfRange: return RequestHeaderNames.IfRange;
                case HttpRequestHeader.IfUnmodifiedSince: return RequestHeaderNames.IfUnmodifiedSince;
                case HttpRequestHeader.MaxForwards: return RequestHeaderNames.MaxForwards;
                case HttpRequestHeader.Pragma: return RequestHeaderNames.Pragma;
                case HttpRequestHeader.ProxyAuthorization: return RequestHeaderNames.ProxyAuthorization;
                case HttpRequestHeader.Range: return RequestHeaderNames.Range;
                //case HttpRequestHeader.Referersic: return RequestHeaderNames.Referersic;
                case HttpRequestHeader.Te: return RequestHeaderNames.TE;
                case HttpRequestHeader.Upgrade: return RequestHeaderNames.Upgrade;
                case HttpRequestHeader.UserAgent: return RequestHeaderNames.UserAgent;
                case HttpRequestHeader.Via: return RequestHeaderNames.Via;
                case HttpRequestHeader.Warning: return RequestHeaderNames.Warning;
                default: return Enum.GetName(typeof(HttpRequestHeader), header);
            }
        }
    }
}
