...
namespace RF.Common.Http
{
    public static class ResponseHeaderNames
    {
        ...
        public const string ContentDisposition181920 = "Content-Disposition[18][19][20]";
        ...
        public static string GetName(this HttpResponseHeader header)
        {
            switch (header)
            {
                case HttpResponseHeader.AcceptRanges: return ResponseHeaderNames.AcceptRanges;
                case HttpResponseHeader.Age: return ResponseHeaderNames.Age;
                case HttpResponseHeader.Allow: return ResponseHeaderNames.Allow;
                case HttpResponseHeader.CacheControl: return ResponseHeaderNames.CacheControl;
                case HttpResponseHeader.Connection: return ResponseHeaderNames.Connection;
                case HttpResponseHeader.ContentEncoding: return ResponseHeaderNames.ContentEncoding;
                case HttpResponseHeader.ContentLanguage: return ResponseHeaderNames.ContentLanguage;
                case HttpResponseHeader.ContentLength: return ResponseHeaderNames.ContentLength;
                case HttpResponseHeader.ContentLocation: return ResponseHeaderNames.ContentLocation;
                case HttpResponseHeader.ContentMd5: return ResponseHeaderNames.ContentMD5;
                //case HttpResponseHeader.ContentDisposition181920: return ResponseHeaderNames.ContentDisposition181920;
                case HttpResponseHeader.ContentRange: return ResponseHeaderNames.ContentRange;
                case HttpResponseHeader.ContentType: return ResponseHeaderNames.ContentType;
                case HttpResponseHeader.Date: return ResponseHeaderNames.Date;
                case HttpResponseHeader.ETag: return ResponseHeaderNames.ETag;
                case HttpResponseHeader.Expires: return ResponseHeaderNames.Expires;
                case HttpResponseHeader.LastModified: return ResponseHeaderNames.LastModified;
                //case HttpResponseHeader.Link: return ResponseHeaderNames.Link;
                case HttpResponseHeader.Location: return ResponseHeaderNames.Location;
                //case HttpResponseHeader.P3P: return ResponseHeaderNames.P3P;
                case HttpResponseHeader.Pragma: return ResponseHeaderNames.Pragma;
                case HttpResponseHeader.ProxyAuthenticate: return ResponseHeaderNames.ProxyAuthenticate;
                //case HttpResponseHeader.Refresh: return ResponseHeaderNames.Refresh;
                case HttpResponseHeader.RetryAfter: return ResponseHeaderNames.RetryAfter;
                case HttpResponseHeader.Server: return ResponseHeaderNames.Server;
                case HttpResponseHeader.SetCookie: return ResponseHeaderNames.SetCookie;
                //case HttpResponseHeader.StrictTransportSecurity: return ResponseHeaderNames.StrictTransportSecurity;
                case HttpResponseHeader.Trailer: return ResponseHeaderNames.Trailer;
                case HttpResponseHeader.TransferEncoding: return ResponseHeaderNames.TransferEncoding;
                case HttpResponseHeader.Vary: return ResponseHeaderNames.Vary;
                case HttpResponseHeader.Via: return ResponseHeaderNames.Via;
                case HttpResponseHeader.Warning: return ResponseHeaderNames.Warning;
                case HttpResponseHeader.WwwAuthenticate: return ResponseHeaderNames.WWWAuthenticate;
                default: return Enum.GetName(typeof(HttpResponseHeader), header);
            }
        }
    }
}
